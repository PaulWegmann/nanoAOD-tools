...
from plots import saveplot, createTH1F
...
histo, trash = createTH1F(tree, "LHE_HT", np.linspace(300,800,100))
...
for fl in files[1:]:
    ...
    tmp2, trash = createTH1F(tree, "LHE_HT", np.linspace(300,800,100), dif=fl)
    tmp2.Scale(weights[area]/entries*luminosity)
    histo.Add(tmp2)
